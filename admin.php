...
if (isset($_POST['submit'])) {
  ...
  // Query to check admin credentials (password is plain text in database)
...
<body>
  ...
  <div class="form_container">
    ...
    <div class="input_container">
      ...
      <input placeholder="name@gmail.com" title="Inpit title" name="email" type="text" class="input_field"
        id="email_field">
    </div>
    <div class="input_container">
    ...
    <span class="subtitle" id="warn" style="color:red; display:none;"><i class="fa-solid fa-triangle-exclamation"></i>
