...
<body>
    ...
    <section id="services-296">
        <div class="cs-container">
            <div class="cs-content">
                ...
                <h2 class="cs-title animate__animated animate__delay-0.5s " data-animation="animate__fadeInUp">We Are
                    Committed To Delivering Top Quality Food Services</h2>
                <br>
                <p class="cs-text animate__animated animate__delay-1s" data-animation="animate__fadeInUp">
                    At FoodVan, we bring the flavors of the streets to your plate with our vibrant food truck
                    experience. </p>
            </div>
            <ul class="cs-card-group">
                <li class="cs-item">
                    ...
                    <p class="cs-item-text">
                        We use the finest ingredients to create mouth-watering dishes that capture the essence of street
                        food.
                    </p>
                    ...
                    <picture class="cs-image" aria-hidden="true">
                        ...
                        <img loading="lazy" decoding="async" src="assets/images/bt1.jpg" alt="library" width="413"
                            height="266">
                    </picture>
                </li>
                <li class="cs-item">
                ...
                <li class="cs-item">
                    ...
                    <p class="cs-item-text">
                        We prioritize hygiene and quality to ensure a safe and enjoyable dining experience for every
                        customer.
                    </p>
        ...
        <div class="cs-container">
            <div class="cs-left">
                ...
                <picture class="cs-picture cs-picture1" aria-hidden="true">
                    ...
                    <img loading="lazy" decoding="async" src="assets/images/main-b.jpg" alt="FoodVan Food Truck"
                ...
                <picture class="cs-picture cs-picture2" aria-hidden="true">
                    <source media="(max-width: 600px)" srcset="assets/images/bt1.jpg">
                    <source media="(min-width: 601px)" srcset="assets/images/bt1.jpg">
                    <img loading="lazy" decoding="async" src="assets/images/bt1.jpg" alt="Delicious Pizza" width="300"
                        height="300">
                </picture>
                <!--Small Image-->
                <picture class="cs-picture cs-picture3" aria-hidden="true">
                    ...
                    <img loading="lazy" decoding="async" src="assets/images/bt4.jpg" alt="Fresh Sushi" width="200"
                        height="200">
                </picture>
            </div>
            <div class="cs-content">
                ...
                <ul class="cs-faq-group">
                    ...
                    <li class="cs-faq-item active">
                        <button class="cs-button">
                            <span class="cs-button-text">
                                Where is FoodVan food truck located?
                            </span>
                        </button>
                        <p class="cs-item-p">
                            Our food truck moves around! Follow us on social media or check our website to see our
                    ...
                    <li class="cs-faq-item">
                        ...
                        <p class="cs-item-p">
                            We specialize in spicy, flavorful street food, including delicious wraps, tacos, and fusion
                    ...
                    <li class="cs-faq-item">
                        ...
                        <p class="cs-item-p">
                            Yes! We have a variety of vegetarian and vegan options to ensure everyone can enjoy our
                            flavors.
                        </p>
                    </li>
                    <li class="cs-faq-item">
                        ...
                        <p class="cs-item-p">
                            Absolutely! You can place your order online or call ahead, and we’ll have it ready for you
                            at our next stop.
                        </p>
                    </li>
                    <li class="cs-faq-item">
                        ...
                        <p class="cs-item-p">
                            Yes, we offer catering services for parties, corporate events, and special occasions.
            ...
            <div class="footer-navbar-container">
                <div class="footer-company-details">
                    ...
                    <div class="footer-content">
                        <p>
                            Taste You Can 'Trust': From our kitchen to your plate, we promise uncompromised quality,
                            genuine service, and memorable flavors.
                        </p>
                    </div>
    ...
    <div class="footer-navbar-col">
        ...
        <ul>
            ...
            <li><a href="products.php"> FoodCounter </a></li>

            <!-- All feedbacks -->
            <li><a href="feedbacks.php"> Feedback </a></li>

            <!-- Reports / insights -->
            <li><a href="reports.php"> Insight </a></li>
    ...
    <div class="footer-navbar-col">
        <h5>Company</h5>
        <ul>
            <!-- You don’t have these pages yet, so send to 404 for now -->
            <li><a href="404error.php"> Terms and Conditions </a></li>
            <li><a href="404error.php"> Polices </a></li>
            <li><a href="404error.php"> Privacy </a></li>

            <!-- Use reports as “Insight” -->
            <li><a href="reports.php"> Insight </a></li>
        </ul>
    </div>
    ...
    <div class="footer-navbar-col">
        ...
        <ul>
            <!-- Orders / commerce -->
            <li><a href="orders.php"> Commerce </a></li>

            <!-- Analyst → reports -->
            <li><a href="reports.php"> Analyst </a></li>

            <!-- Inventory as another insight-style page -->
            <li><a href="inventory.php"> Insight </a></li>

            <!-- Products again for marketing / offers -->
            <li><a href="products.php"> Marketing </a></li>
        </ul>
    </div>
</div>
