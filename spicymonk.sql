...
(1, 'assets/images/dish/Dish-2.png', 4.3, 'Spicy O\'tel saga', 'Spicy dish with sauces and greens make it more delicious and spicy 100% veg.', 'Veg', 2, 219.00, 'Burgers'),
(2, 'assets/images/dish/Dish-3.png', 4.9, 'Spicy Noodles', 'Spicy Noodles with green chutney serving 2 adding spicy touch to taste.', 'Veg', 2, 314.00, 'Pizza'),
(3, 'assets/images/dish/Dish-4.png', 4.9, 'Spicy Hunger\' Bowl', 'Spicy hunger bowl serves you best taste with 100% hygiene and ingredients', 'Non Veg', 2, 349.00, 'Bowls'),
(4, 'assets/images/dish/bev-1.png', 4.1, 'Green lemonade', 'Makes you chill with green healthy ingredients sure you your taste', 'Veg', 1, 89.00, 'Beverages'),
(5, 'assets/images/dish/bev-2.png', 4.3, 'Orange Olif', 'Taste of Oranges with hygiene ingredients makes mood fresh', 'Veg', 1, 99.00, 'Beverages'),
(6, 'assets/images/dish/bev-3.png', 4.9, 'Lemonade Rush', 'Yellow Lemon integration with delight taste ensures your mood', 'Veg', 1, 119.00, 'Beverages'),
(7, 'assets/images/dish/4.png', 4.3, 'Spicy Red O\' Nod', 'Inspired by the deep reds of chili and the warmth of handcrafted seasonings.', 'Veg', 2, 239.00, 'noodles'),
(8, 'assets/images/dish/Dish-5.png', 4.1, 'Asian Noodles', 'Inspired by the deep reds of chili and the warmth of handcrafted seasonings.', 'Veg', 2, 249.00, 'noodles'),
(9, 'assets/images/dish/spicy-noodles-black.png', 4.9, 'Korean Spicy Stew', 'Deep reds of chili and the warmth of handcrafted seasonings and flavours.', 'Non Veg', 1, 329.00, 'Bowls'),
(10, 'assets/images/dish/spicy-noodles-black.png', 4.1, 'Spicy O\'il Haka', 'Inspired by the chili and the warmth of handcrafted seasonings and taste touch.', 'Non Veg', 2, 189.00, 'Bowls'),
(11, 'assets/images/dish/Dish-5.png', 4.1, 'Red Souce Noodles', 'From the smoky wok-kissed taste of chow mein to the comforting warmth', 'Non Veg', 2, 349.00, 'noodles'),
(12, 'assets/images/dish/4.png', 4.3, 'Spaghetti Aglio e Olio', 'Spaghetti Aglio e Olio is a classic Italian pasta dish that embraces simplicity', 'Veg', 2, 229.00, 'noodles'),
...
CREATE TABLE IF NOT EXISTS `user_details` (
  ...
  `Uaddress` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
